                ...
                <div>
                  ...
                  {propertyOptions.length === 0 ? (
                    <p className="text-xs text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-2">
                      Agrega una propiedad de interés en el detalle del prospecto antes de registrar
                      la venta.
                    </p>
                  ) : (
                    <select
                  ...
                  {selectedProperty &&
                    (selectedProperty.price != null ? (
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                        Precio de lista: {formatPrice(selectedProperty.price)} · puedes ajustarlo si
                        la venta fue por otro monto
                      </p>
                    ) : (
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                        Esta propiedad no tiene precio de lista (PENDIENTE) — captura el monto
                        manualmente
                      </p>
                    ))}
                </div>
