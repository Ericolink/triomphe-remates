...
export default function ReportsSection() {
  ...
  return (
    <CollapsibleSection title="Reportes comerciales" icon={<PieChart size={16} className="text-blue-700 dark:text-blue-400" />}
      subtitle="embudo, motivos de cierre, desempeño por asesor" onOpen={() => setEverOpened(true)}>
      {isLoading || !d ? (
            ...
            <motion.div variants={fadeInUp} className="bg-gray-50 dark:bg-[#1a1f2e] rounded-2xl p-5">
              ...
              {(d?.porAsesor ?? []).length === 0 ? (
                ...
                <div className="space-y-2">
                  {d.porAsesor.map((a) => (
                    <div key={a.userId} className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-white dark:bg-[#242938] text-sm">
