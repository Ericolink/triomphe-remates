  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="w-px h-5 bg-primary-700" />
        {statusOptions.length > 0 && (
          <select
            onChange={(e) => {
              if (e.target.value) onStatus(e.target.value);
              e.target.value = '';
            }}
            defaultValue=""
            className="text-sm bg-primary-800 border border-primary-700 rounded-lg px-2 py-1 text-white focus:outline-none cursor-pointer"
          >
