  ...
  return (
    <Link to={`/propiedades/${property.slug}`} className="group block">
      <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        ...
        {/* Info */}
        <div className="p-5">
          <p className="text-2xl font-bold text-blue-900 mb-1">{formatPrice(property.price)}</p>
          ...
          <div className="flex items-center gap-1 text-gray-500 text-sm mb-4">
            ...
            {property.bank && <span className="ml-auto text-xs text-gray-400">{property.bank}</span>}
          </div>
