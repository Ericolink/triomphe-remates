...
import { CITY_LABELS, STATUS_LABELS, STATUS_VARIANTS, WHATSAPP_NUMBER } from '../../utils/constants';
      ...
      >
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between border-t border-gray-100 dark:border-[#2e3650] pt-3">
            ...
            <button
              type="button"
              onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open(waHref, '_blank', 'noopener,noreferrer'); }}
