      ...
      <Suspense fallback={<PageFallback />}>
        <Routes>
          ...
          <Route path="/admin" element={
            ...
            <Route path="calendario"             element={<Navigate to="/admin/crm?tab=calendario" replace />} />
            <Route path="campanas"               element={<Navigate to="/admin/crm?tab=campanas" replace />} />
            <Route path="casos-exito"            element={<Navigate to="/admin/crm?tab=casos-exito" replace />} />
