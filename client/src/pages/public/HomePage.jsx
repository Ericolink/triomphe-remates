    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 dark:from-[#0f1621] dark:via-blue-950 dark:to-[#1a1f2e] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 text-center">
          ...
          <form onSubmit={handleSearch} className="bg-white dark:bg-[#242938] rounded-2xl p-3 max-w-2xl mx-auto flex flex-col sm:flex-row gap-3 shadow-2xl border border-transparent dark:border-[#2e3650]">
            ...
            <button type="submit"
              className="bg-blue-900 dark:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-medium flex items-center gap-2 hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
      ...
      {/* Stats */}
      <section className="bg-yellow-400 dark:bg-yellow-500 py-8">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-8">
          ...
          <button onClick={() => navigate('/propiedades')}
            className="hidden md:flex items-center gap-2 text-blue-700 dark:text-blue-400 font-medium hover:gap-3 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={title} className="bg-white dark:bg-[#1a1f2e] rounded-2xl p-8 shadow-md dark:shadow-none border border-transparent dark:border-[#2e3650] text-center hover:shadow-lg transition-shadow">
