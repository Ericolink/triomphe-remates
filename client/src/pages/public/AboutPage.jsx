    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-blue-900 to-blue-700 dark:from-[#0f1621] dark:to-[#1a1f2e] text-white py-20">
        ...
        >
          ...
          >
            Más de 27 años conectando inversionistas con las mejores oportunidades de remates
            bancarios en México.
          </motion.p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection variant={fadeInLeft}>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              Triomphe Bienes Raíces es un despacho dedicado
              a la venta de remates bancarios mediante la cesión de derechos litigiosos,
              adjudicatarios o de escritura.
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              Con más de{' '}
              <strong className="text-blue-900 dark:text-white">27 años de experiencia</strong>,
              nuestro equipo ofrece a sus inversionistas importantes ahorros y utilidades, con
              garantías hipotecarias respaldadas por gravámenes en el Registro Público de la
              Propiedad.
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Operamos activamente en Chihuahua, Ciudad Juárez y Querétaro, con un amplio inventario
              de propiedades disponibles a precios por debajo del valor comercial.
            </p>
          </AnimatedSection>
          ...
          >
            {[
              {
                icon: <Building2 size={28} className="text-yellow-500" />,
                value: stats?.total ? `${stats.total}+` : '...',
                label: 'Propiedades en inventario',
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center max-w-3xl mx-auto mb-12">
              ...
              otorgan los derechos crediticios litigiosos y/o adjudicatarios de un inmueble,
          ...
          <motion.div variants={fadeInLeft} whileHover={{ y: -4, transition: { duration: 0.2 } }}>
            <div className="bg-blue-900 dark:bg-[#0f1621] text-white rounded-2xl p-8 h-full">
              ...
              <p className="text-blue-100 leading-relaxed">
                ...
                orientados al servicio en todas las etapas de nuestra intervención en la venta,
                compra o alquiler, basados en nuestra experiencia y capacitación en el ramo.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeInRight} whileHover={{ y: -4, transition: { duration: 0.2 } }}>
            <div className="bg-yellow-400 dark:bg-yellow-500 rounded-2xl p-8 h-full">
              ...
              <p className="text-blue-900 leading-relaxed">
                ...
                sientan plenamente acompañados y asesorados durante todo el proceso de compra, para
