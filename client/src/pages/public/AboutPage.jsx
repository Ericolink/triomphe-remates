  ...
  return (
    <div>
      <SEO
        ...
        description="Conoce a Triomphe Bienes Raíces, especialistas en remates bancarios con más de 10 años de experiencia."
        url="/nosotros"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              acompañando a nuestros clientes desde la búsqueda de la propiedad hasta la firma ante notario.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={label} className="bg-gray-50 dark:bg-[#242938] border border-transparent dark:border-[#2e3650] rounded-2xl p-6 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={title} className="bg-white dark:bg-[#1a1f2e] rounded-2xl p-8 shadow-md dark:shadow-none border border-transparent dark:border-[#2e3650] text-center">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={city} className="bg-white dark:bg-[#242938] border border-gray-100 dark:border-[#2e3650] rounded-2xl p-6 hover:shadow-lg transition-shadow">
