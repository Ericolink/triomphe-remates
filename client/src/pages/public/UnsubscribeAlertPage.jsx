...
export default function UnsubscribeAlertPage() {
  ...
  const errorMessage =
    ...
    'Ocurrió un error al cancelar la alerta. Intenta de nuevo más tarde.';
  ...
  return (
    ...
    >
      <SEO
        ...
        description="Cancela tus alertas de propiedades de Triomphe Bienes Raíces."
        url="/cancelar-alerta"
      />
        ...
        {!token ? (
          <>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              El enlace de cancelación no incluye un token válido. Verifica que copiaste la URL
              completa desde tu correo.
            </p>
          </>
        ) : isLoading ? (
          <>
