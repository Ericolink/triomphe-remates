  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-blue-900 dark:text-white mb-3">Contáctanos</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-blue-900 dark:text-white">Información de contacto</h2>
          {[
            ...
            <div key={title} className="flex gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-transparent dark:border-gray-700">
