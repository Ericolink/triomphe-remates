  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        <motion.h1
          variants={fadeInUp}
          className="text-4xl font-bold text-blue-900 dark:text-white mb-3"
        >
          Contáctanos
        </motion.h1>
          ...
          {[
            {
              ...
              title: 'Teléfono',
              lines: ['+52 (656) 579-2750'],
            },
            {
              icon: <Mail size={20} className="text-yellow-500" />,
              title: 'Email',
              lines: ['t.bienesraicesmx@gmail.com', 'TriompheSistemas@gmail.com'],
            },
            {
              icon: <MapPin size={20} className="text-yellow-500" />,
              title: 'Ciudades',
              lines: ['Cd. Juárez, Chihuahua', 'Chihuahua, Chih.', 'Querétaro, Qro.'],
            },
            {
              icon: <Clock size={20} className="text-yellow-500" />,
              title: 'Horario',
              lines: ['Lun - Vie: 9:00 AM - 6:00 PM'],
            },
