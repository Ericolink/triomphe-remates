...
const FIELDS = [
  ...
  {
    key: 'debtsUpdateDate',
    label: 'Fecha de actualización de adeudos (opcional)',
    type: 'date',
    col: 1,
    section: 'legal',
  },
...
const propertyToForm = (p) => ({
  ...
  zone: p.zone || '',
  waterDebt: p.waterDebt || '',
  electricityDebt: p.electricityDebt || '',
  propertyTaxDebt: p.propertyTaxDebt || '',
  debtsUpdateDate: p.debtsUpdateDate
    ? new Date(p.debtsUpdateDate).toISOString().split('T')[0]
    : '',
