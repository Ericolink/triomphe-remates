                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3 text-xs text-gray-500 dark:text-gray-400 mt-1">
                    <span className="flex items-center gap-1">
                      <Briefcase size={11} /> {JOB_TYPE_LABELS[position.type]}
                    </span>
                    <span className="flex items-center gap-1">
                      <Users size={11} /> {position.applications?.length ?? 0} postulaciones
                    </span>
                    ...
                    items={[
                      {
                        ...
                        onClick: () =>
                          setConfirm({
                            title: `¿Eliminar "${position.title}"?`,
                            message:
                              'La vacante y sus postulaciones asociadas serán eliminadas permanentemente.',
                            onConfirm: () => {
