...
import { Building2, Eye, TrendingUp, MapPin, Home, Target, ArrowRight, Users } from 'lucide-react';
...
// Desgloses y gráficas detalladas — separadas del Dashboard para que ese quede
// enfocado únicamente en lo accionable del día a día.
  ...
  return (
    <div>
      <motion.div variants={fadeIn} initial="hidden" animate="visible" className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Desempeño e inventario a detalle</p>
      </motion.div>

      {/* Stats generales */}
      <motion.div className="grid grid-cols-2 gap-4 mb-8" variants={staggerContainer} initial="hidden" animate="visible">
        {[
