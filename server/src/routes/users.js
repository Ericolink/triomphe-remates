...
const { getUsers, createUser, updateUser, deactivateUser, activateUser, permanentDeleteUser } = require('../controllers/usersController');
...
router.put('/:id', uploadLimiter, authenticate, authorize('admin'), upload.single('profilePhoto'), updateUser);
